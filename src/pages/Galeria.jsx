      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map(i => (
            <div
              key={i}
              className="aspect-square rounded-2xl bg-sky-canvas/5 flex items-center justify-center border-2 border-dashed border-sky-canvas/20 hover:border-action-blue/30 transition-colors cursor-pointer group"
            >
              <div className="text-center p-8">
                <svg className="w-16 h-16 mx-auto mb-4 text-sky-canvas/30 group-hover:text-action-blue/40 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
