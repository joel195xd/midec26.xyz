                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      className="flex items-center gap-2 px-4 py-3 bg-[#1DB954]/10 text-[#1DB954] rounded-full text-sm font-medium hover:bg-[#1DB954]/20 transition-colors"
                    >
                    ...
                    {track.youtube && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-4 py-3 bg-red-500/10 text-red-500 rounded-full text-sm font-medium hover:bg-red-500/20 transition-colors"
                      >
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
